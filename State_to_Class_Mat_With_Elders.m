function [E,NGrid,tickGrid,DemGrid] = State_to_Class_Mat_With_Elders(kB,kL,kR,TB,TL,ClassBds,StopProb,points)
...
E(find(tickGrid<=kB+kL+kB),end-1)=E(find(tickGrid<=kB+kL+kB),end-1)+2; % Add parents
E(find(tickGrid>kB+kL+kB),end)=2; % Add elders
